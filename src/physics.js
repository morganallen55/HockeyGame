...
const enforceBoundaryConstraints = (entities) => {
  ...
  [entities.puck.body, entities.player1.body, entities.player2.body,
   entities.enemy1.body, entities.enemy2.body,
   entities.goalie1.body, entities.goalie2.body].forEach(clamp);
};
